...
const loadBlueprint = async function () {
    ...
    const urls = ['https://www.virginmedia.com/my-virgin-media/home'];
...
const loadUrl = async function (page, url, takeScreenshot) {
    ...
    if (domcontentloaded && takeScreenshot) {
        ...
        await page.waitForSelector('.consent_prompt_container #consent_prompt_submit')
        await page.click('.consent_prompt_container #consent_prompt_submit')
